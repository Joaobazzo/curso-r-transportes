...
**Pacotes:** `sf`, `terra`, `tidyterra`, `geobr`, `censobr`, `sidrar`, `osmdata`, `elevatr`, `leaflet`, `ggspatial`
...
| 4 | Geovisualização: `geom_sf`, `leaflet`, mapas de conferência | @sec-m2-mapas |
...
pacotes <- c("sf", "terra", "tidyterra", "geobr", "censobr", "sidrar",
             "osmdata", "osmextract", "elevatr", "leaflet", "ggspatial", "units")
